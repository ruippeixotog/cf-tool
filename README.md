...
[![Github release](https://img.shields.io/github/release/xalanq/cf-tool.svg)](https://github.com/ruippeixotog/cf-tool/releases)
[![platform](https://img.shields.io/badge/platform-Windows%20%7C%20macOS%20%7C%20Linux-blue.svg)](https://github.com/ruippeixotog/cf-tool/releases)
[![Build Status](https://travis-ci.org/xalanq/cf-tool.svg?branch=master)](https://travis-ci.org/xalanq/cf-tool)
[![Go Report Card](https://goreportcard.com/badge/github.com/ruippeixotog/cf-tool)](https://goreportcard.com/report/github.com/ruippeixotog/cf-tool)
...
You can download the pre-compiled binary file in [here](https://github.com/ruippeixotog/cf-tool/releases).
...
```plain
$ go get github.com/ruippeixotog/cf-tool
$ cd $GOPATH/src/github.com/ruippeixotog/cf-tool
 ...
 * You can download the binary file in here https://github.com/ruippeixotog/cf-tool (Windows, macOS, Linux)
 * Author: $%U%$
 * Time: $%Y%$-$%M%$-$%D%$ $%h%$:$%m%$:$%s%$
**/
